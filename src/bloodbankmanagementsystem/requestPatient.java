 ...
 * @author pc
 */
public class requestPatient extends javax.swing.JFrame {

    /**
     * Creates new form requestPatient
     */
    String name;
    public requestPatient(String username) {
        initComponents();
        this.name = username;
    ...
    private void initComponents() {
        ...
        causeField = new javax.swing.JTextField();
        ...
        Login_title.setText("Request for Blood");

        P_request.setBackground(new java.awt.Color(0, 153, 153));
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addComponent(BgOption, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(causeField))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(125, 125, 125)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(P_request, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(P_list, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        String dieases = causeField.getText();
        ...
        if(verifyFields()){
            PreparedStatement ps;
                    ResultSet rs;
                    String requestQuery = "INSERT INTO `patient_request`(`username`, `blood_gp`, `quantity`, `Cause`, `status`) VALUES (?,?,?,?,?);";
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(requestPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new requestPatient().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField causeField;
